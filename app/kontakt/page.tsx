...
export const metadata: Metadata = {
  ...
  keywords: ["kontakt ART DUM", "poptávka stavba", "cenová nabídka", "telefon stavební firma", "Třebíč kontakt"],
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Kontakt - Oleh Kulish, OSVČ - ART DUM | Stavební firma Třebíč",
      },
    ],
  },
  twitter: {
