...
-- Create inquiries table (poptávky)
...
-- Inquiries policies - only admins and owners can view
...
create policy "inquiries_insert_public"
  ...
  with check (true); -- Anyone can submit inquiry
...
-- Create projects table (projekty)
...
-- Projects policies - only admins and owners
